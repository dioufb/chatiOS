...
public class CONNECTCHATIOSConnectChatiOSClient: AWSAPIGatewayClient {
    ...
    /*
     ...
     return type: 
     */
    public func startChatOptions() -> AWSTask<AnyObject> {
	    ...
	    return self.invokeHTTPRequest("OPTIONS", urlString: "/startChat", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: nil)
	}
    ...
    public func startChatProxyOptions() -> AWSTask<AnyObject> {
	    ...
	    return self.invokeHTTPRequest("OPTIONS", urlString: "/startChat/{proxy+}", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: nil)
	}
